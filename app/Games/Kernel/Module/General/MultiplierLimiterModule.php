...
class MultiplierLimiterModule extends Module {
    ...
    function lose(Data $data): bool {
        return Modules::get($this->game, $data->demo())->get($this, 'pass') !== '-1' && $this->chance(floatval(Modules::get($this->game, $data->demo())->get($this, 'pass'))) ? false
            : $this->game->multiplier($this->dbGame, $this->data, $this->result) > floatval(Modules::get($this->game, $data->demo())->get($this, 'multiplier'));
    }
