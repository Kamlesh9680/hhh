...
class User extends \Jenssegers\Mongodb\Auth\User {
    ...
    protected $fillable = [
        ...
        'demo_eos', 'demo_xrp', 'demo_xlm', 'demo_xtz', 'demo_wbtc', 'demo_zec', 'demo_rub',
    ...
    public $hidden = [
        ...
        'demo_btc', 'demo_ltc', 'demo_eth', 'demo_doge', 'demo_bch', 'demo_trx', 'demo_algo', 'demo_btg', 'demo_celo', 'demo_dash',
        'demo_eos', 'demo_xrp', 'demo_xlm', 'demo_xtz', 'demo_wbtc', 'demo_zec',
    ...
    private function vipData(): array {
        if(!env('APP_DEBUG') && Cache::has('vip:'.$this->_id.':level'))
            return [
    ...
    public function tfa(): TwoFactorAuth {
        return new TwoFactorAuth('rivemont.io/'.$this->name);
    }
