...
class PlayWhisper extends WebSocketWhisper {
    ...
    public function process($data): array {
        ...
        if($game instanceof ThirdPartyGame && $this->user == null) return ['code' => -9, 'message' => 'Log in to play games from third-parties'];
        ...
        if(!$game instanceof ThirdPartyGame && $this->user != null && ($this->user->balance(Currency::find($data->currency))->demo($data->demo)->get() < floatval($data->bet))) return ['code' => -4, 'message' => 'Not enough money'];
