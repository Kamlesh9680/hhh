        ...
        <div class="fixed">
            <div class="container-fluid">
                <div class="header-container">
                    ...
                    <div class="menu">
                        <router-link tag="div" to="/casino" :class="isCasino() && $route.path !== '/' ? 'active' : ''">{{ $t('general.head.casino') }}</router-link>
                        <router-link tag="div" to="/sport" :class="!isCasino() ? 'active' : ''">{{ $t('general.head.sport') }}</router-link>
                    </div>
                    ...
                    <div class="wallet" v-if="!isGuest && currencies" v-click-outside="() => expand = false">
                        <div :class="`wallet-switcher ${expand ? 'active' : ''}`">
                            ...
                            <div class="option mt-2 mb-1" @click="$store.commit('setFiatView', !fiatView)">
                                <div class="wallet-switcher-icon">
                            ...
                            <div class="option select-option mt-2">
                                <div class="wallet-switcher-icon">
                        ...
                        <div class="balance" @click="demo ? openDemoBalanceModal() : $router.push('/wallet')">
                            <unit :fiat="fiatView" :to="currency" :value="currencies[currency].balance[demo ? 'demo' : 'real']"></unit>
